<x-app>
    <header class="mb-6 relative">
        ...
        <p class="text-sm">
            ...
            Aliquam amet debitis dolore dolores eum hic itaque libero maxime modi molestiae nam odit quia quisquam reprehenderit repudiandae sint, soluta, tenetur veritatis.
        </p>
